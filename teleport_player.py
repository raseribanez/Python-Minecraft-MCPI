# Ben Woodfield
# Minecraft Pi - Python
# Use this script to teleport to another location within the world
# So you need to get your existing coords from the game (FROM)
# and enter your desired location coords (TO)
